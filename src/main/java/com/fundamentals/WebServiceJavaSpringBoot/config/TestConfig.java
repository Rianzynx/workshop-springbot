...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2025-11-11T16:21:09Z"), u1);
        Order o2 = new Order(null, Instant.parse("2025-12-23T18:29:01Z"), u2);
        Order o3 = new Order(null, Instant.parse("2025-05-16T16:23:09Z"), u1);
